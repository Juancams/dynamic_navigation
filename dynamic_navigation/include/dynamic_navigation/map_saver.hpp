...
#ifndef DYNAMIC_NAVIGATION__MAP_SAVER_HPP_
#define DYNAMIC_NAVIGATION__MAP_SAVER_HPP_
...
protected:
  ...
  /**
   * @brief Periodically save the map
   */
  ...
  // The name of the path to save the map
  ...
  // Timer for periodic map saving
  rclcpp::TimerBase::SharedPtr save_map_timer_;
};

}  // namespace dynamic_navigation

#endif  // DYNAMIC_NAVIGATION__MAP_SAVER_HPP_
